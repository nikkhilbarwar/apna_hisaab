...
class _StockScreenState extends State<StockScreen> {
    ...
    return Container(
      ...
      child: Row(
        children: [
              ...
              onPressed: () {
                if (_selectedCategory != null) {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (c) =>
                          ItemManagementScreen(category: _selectedCategory!),
                    ),
                  );
                } else {
                  _showCategoryPicker(context, catProvider, profile);
                }
              },
          ...
          const SizedBox(width: 12),
          IconButton(
            onPressed: () => _showStockSettingsBottomSheet(
              context,
              itemProvider,
              catProvider,
              profile,
  ...
  void _showStockSettingsBottomSheet(
            ...
            _actionTile(
              ...
              () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const PurchaseReminderScreen(),
                  ),
                );
              },
            ),
  ...
  Widget _buildCategoryList(
    ...
    final List<String> categories = catProvider.categories
        .map((c) => c.name)
        .toList();
        ...
        builder: (context, setModalState) => Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Toggle alerts for entire categories or specific items.',
                style: TextStyle(
                  color: profile.secondaryTextColor,
                  fontSize: 12,
                ),
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final allOn =
                        catItems.isNotEmpty &&
                        catItems.every((i) => i.lowStockAlert == 1);
                        ...
                        children: catItems
                            .map(
                              (item) => ListTile(
                                ...
                                subtitle: Text(
                                  'Current: ${item.currentStock % 1 == 0 ? item.currentStock.toInt() : item.currentStock} ${item.unit}',
  ...
  void _showItemActions(
    ...
    CategoryModel? cat;
    try {
      cat = Provider.of<CategoryProvider>(
        context,
        listen: false,
      ).getCategoryByName(item.category);
    } catch (_) {}
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText:
                    'Current: ${item.currentStock % 1 == 0 ? item.currentStock.toInt() : item.currentStock}',
                hintStyle: TextStyle(
                  color: profile.secondaryTextColor.withValues(alpha: 0.4),
                ),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                final newVal =
                    double.tryParse(stockController.text) ?? item.currentStock;
